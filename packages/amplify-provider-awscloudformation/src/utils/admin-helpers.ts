...
export const adminBackendMap: {
  ...
  'ap-northeast-1': {
    ...
    appStateUrl: 'https://ap-northeast-1.appstate.amplifyapp.com/wave4Prod',
  },
  'ap-northeast-2': {
    amplifyAdminUrl: 'https://ap-northeast-2.admin.amplifyapp.com',
    appStateUrl: 'https://ap-northeast-2.appstate.amplifyapp.com/wave4Prod',
  },
  'ap-south-1': {
    amplifyAdminUrl: 'https://ap-south-1.admin.amplifyapp.com',
    appStateUrl: 'https://ap-south-1.appstate.amplifyapp.com/wave4Prod',
  },
  'ap-southeast-1': {
    amplifyAdminUrl: 'https://ap-southeast-1.admin.amplifyapp.com',
    appStateUrl: 'https://ap-southeast-1.appstate.amplifyapp.com/wave3Prod',
  },
  'ap-southeast-2': {
    amplifyAdminUrl: 'https://ap-southeast-2.admin.amplifyapp.com',
    appStateUrl: 'https://ap-southeast-2.appstate.amplifyapp.com/wave4Prod',
  },
  'ca-central-1': {
    amplifyAdminUrl: 'https://ca-central-1.admin.amplifyapp.com',
    appStateUrl: 'https://ca-central-1.appstate.amplifyapp.com/wave5Prod',
  },
  'eu-central-1': {
    amplifyAdminUrl: 'https://eu-central-1.admin.amplifyapp.com',
    appStateUrl: 'https://eu-central-1.appstate.amplifyapp.com/wave4Prod',
  },
  'eu-north-1': {
    amplifyAdminUrl: 'https://eu-north-1.admin.amplifyapp.com',
    appStateUrl: 'https://eu-north-1.appstate.amplifyapp.com/wave5Prod',
  },
  'eu-west-1': {
    amplifyAdminUrl: 'https://eu-west-1.admin.amplifyapp.com',
    appStateUrl: 'https://eu-west-1.appstate.amplifyapp.com/wave3Prod',
  },
  'eu-west-2': {
    amplifyAdminUrl: 'https://eu-west-2.admin.amplifyapp.com',
    appStateUrl: 'https://eu-west-2.appstate.amplifyapp.com/wave1Prod',
  },
  'eu-west-3': {
    amplifyAdminUrl: 'https://eu-west-3.admin.amplifyapp.com',
    appStateUrl: 'https://eu-west-3.appstate.amplifyapp.com/wave5Prod',
  },
  'me-south-1': {
    amplifyAdminUrl: 'https://me-south-1.admin.amplifyapp.com',
    appStateUrl: 'https://me-south-1.appstate.amplifyapp.com/wave5Prod',
  },
  'sa-east-1': {
    amplifyAdminUrl: 'https://sa-east-1.admin.amplifyapp.com',
    appStateUrl: 'https://sa-east-1.appstate.amplifyapp.com/wave5Prod',
  },
  'us-east-1': {
    amplifyAdminUrl: 'https://us-east-1.admin.amplifyapp.com',
    appStateUrl: 'https://us-east-1.appstate.amplifyapp.com/wave3Prod',
  },
  'us-east-2': {
    amplifyAdminUrl: 'https://us-east-2.admin.amplifyapp.com',
    appStateUrl: 'https://us-east-2.appstate.amplifyapp.com/wave2Prod',
  },
  'us-west-1': {
    amplifyAdminUrl: 'https://us-west-1.admin.amplifyapp.com',
    appStateUrl: 'https://us-west-1.appstate.amplifyapp.com/wave5Prod',
  },
  'us-west-2': {
    amplifyAdminUrl: 'https://us-west-2.admin.amplifyapp.com',
    appStateUrl: 'https://us-west-2.appstate.amplifyapp.com/wave4Prod',
  },
};
